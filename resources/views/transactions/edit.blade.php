                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('quantity') is-invalid @enderror" name="quantity" value="{{ old('quantity', $transactions->quantity) }}" placeholder="Masukkan Jumlah Produk yang Dipesan">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('status') is-invalid @enderror" name="status" value="{{ old('status', $transactions->status) }}" placeholder="Masukkan Kode Status Produk">
